...
send(msg.chat_id,msg.id,"≠ اهلا بك في صانع بوتات سورس ثري ثون \n≠ قناة السورس @CCYFC","html",true, false, false, true, reply_markup)
return false 
end
...
local IdUser_Info = LuaTele.searchPublicChat("TT_LLJ")
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸   ](t.me/CCYFC )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/TT_LLJ '},
},
{
{text = '• مطور السورس •', url = 't.me/TT_LLJ'},
},
{
{text = '• قناة التحديثات •', url = 't.me/CCYFC '},
},
{  
{text = '• 𝑆𝑂𝑈𝑅𝐶𝐸  •', url = 't.me/CCYFC '},
},
}
