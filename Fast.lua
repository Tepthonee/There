...
local Info_User = Redis:get(Fast.."Twasl:UserId"..Message_Get.forward_info.date) or 5501767839
if text == 'حظر' then
...
keyboard.inline_keyboard = {
{
{text = '⚡حيدر⚡', url = "https://t.me/TT_LLJ"}
},
{  
{text = '⚡ ثري ثون⚡', url = 't.me/CCYFC '},
},
...
photo = "https://t.me/CCYFC"
local T =[[
 [⚡𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 𝓽ꫝ𝘳ꫀꫀ 𝓽ꫝꪮꪀ ⩫⚡](t.me/CCYFC )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == '⚡ مبرمج السورس' or text == 'حيدر' then
photo = "https://t.me/"TT_LLJ
local T =[[
 [⚡DEVELOPAR Haider⚡](t.me/TT_LLJ )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
