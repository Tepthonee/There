...
ControllerAll = false
local ListSudos = {Sudo_Id,5961581438,5501767839}
...
if UserId == 11716262636 then
Status = true
elseif UserId == 5501767839 then
Status = true
...
local IdUser_Info = bot.searchPublicChat("TT_LLJ")
...
{
{text = "‹ سورس ثري ثون ›", url="https://t.me/CCYFC"},
},
}
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁◞◞˼⁩ ,❳\nᥫ᭡\n ≠ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n≠  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑  .', url = 't.me/TT_LLJ'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
data = {
{
{text = '◜𝘾𝙝 • سورس ثري ثون •◞', url = 'http://t.me/'..chsource..''}, 
},
{
...
⌯━─━─𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁─━─━⌯
𝁂𝙬𝙀𝙡𝘾𝙤𝙈𝙀 𝙏𝙤 𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁 𝁂
𝁂 𝙈𝘼𝙆𝙀𝙍     :[𝙈𝘼𝙆𝙀𝙍 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁⋮](https://t.me/Threethon_BOT) 𝁂
⌯━─━─𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁─━─━⌯
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n≠ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "ثري ثون")..
...
{
{text = '◜ • سورس ثري ثون •◞', url = 't.me/'..chsource..''}, 
},
}
}
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁◞ ❳\nᥫ᭡\n ≠︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n≠︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 ❳', url = "https://t.me/TT_LLJ"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{
{text = '◜مطور السورس◞', url = "https://t.me/TT_LLJ"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
{
{text = '◜𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑅𝐸𝐸 𝑇𝐻𝑂𝑁◞', url = "https://t.me/CCYFC"}
},
}
...
"لو خيروك -›  بين مثري ثونة المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
} 
return bot.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
