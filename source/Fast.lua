...
chsource = Redis:get(Fast..'chsource') or "CCYFC"
devsource = Redis:get(Fast..'devsource') or "TT_LLJ"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5501767839,5893347792,0000000000000}
...
xname =  (Redis:get(Fast.."Name:Bot") or "ثري ثون") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5501767839) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5501767839) then
...
if tonumber(senderr) == 5501767839 then
...
local UserId_Info = bot.searchPublicChat("TT_LLJ")
...
local TestText = "  ❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉𓆪✭𓂁 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯⎖᳒𝘿𝙀𝙑⌯⤹► ◞', url = "https://TT_LLJ"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉𓆪✭𓂁 ❳', url = "https://t.me/TT_LLJ"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉𓆪✭𓂁 ❳', url = "https://t.me/CCYFC"},
},
}
local msg_id = msg.id/2097152/0.5 
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ Threethon  ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/TT_LLJ"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج ثري ثون ❳', url = "https://t.me/TT_LLJ"}
},
{
{text = '❲ ⁨𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉 ❳', url = "https://t.me/CCYFC"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'مطور سورس' or text == 'حيدر' then  
local UserId_Info = bot.searchPublicChat("TT_LLJ")
if UserId_Info.id then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉◞◞˼⁩ ,❳\nᥫ᭡\n ✭ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✭  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 ˛ َِ𝗛َِ𝗮َِ𝗶َِ𝗱َِ𝗲َِ𝗿 .  .', url = 't.me/TT_LLJ'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5501767839) then
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "ثري ثون")
if text then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5501767839) then
local txx = "\n"
...
if text == 'السورس' or text == 'سورس' or text == 'ثري ثون' or text == 'يا سورس' or text == 'فينيميمبننجا' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '◜ ⎖᳒𝘿𝙀𝙑⌯⤹►◞', url = 't.me/'..devsource}, 
},
{
{text = '◜𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐇𝐑𝐄𝐄 𝐓𝐇𝐎𝐍⚡️◞', url = 'http://t.me/'..chsource..''}, 
},
{
...
⍟ 𝚆𝙴𝙻𝙲𝙾𝙼 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙷𝚁𝙴𝙴 𝚃𝙷𝙾𝙽
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉─━─━⌯
★ [𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉](https://t.me/CCYFC) 
★ [˛ َِ𝗛َِ𝗮َِ𝗶َِ𝗱َِ𝗲َِ𝗿 .](https://t.me/TT_LLJ) 
⌯━─━─𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉─━─━⌯
⍟ 𝚆𝙴𝙻𝙲𝙾𝙼 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝚃𝙷𝚁𝙴𝙴 𝚃𝙷𝙾𝙽
⍟ [𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉](https://t.me/CCYFC) 
...
photo = "https://t.me/CCYFC"
local Name = "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗠𝗔𝗥𝗞𝗘𝗧 𝗧𝗛𝗥𝗘𝗘 𝗧𝗛𝗢𝗡\n"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '◜ ⎖᳒𝘿𝙀𝙑⌯⤹►◞', url = 't.me/'..devsource}, 
...
{
{text = '☢️ › إضغط هنا لتنصيب بوتك', url = 't.me/Haidervnbot?start'}
},
{
{text = 'اضف البوت إلى مجموعتك✅', url = 't.me/'..UserBot..'?startgroup=new'}
},
...
if text == (Redis:get(Fast.."Name:Bot") or "ثري ثون") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "ثري ثون")
    local NameBots = {
"قلب "..NamesBot ,
"ليش ضايج",
"كافي",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "ثري ثون")..
'\n🤖⋮ اختصاص البوت حماية المجموعات'..
'\n💻⋮ لتفعيل البوت عليك اتباع مايلي ...'..
'\n🚀⋮ اضف البوت الى مجموعتك'..
'\n🤴🏽⋮ ارفعه ادمن مشرف'..
'\n🕹⋮ ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n🔮⋮ ارسل كلمة { /Threethon } لاظهار الكيبورد'..
'\n💥⋮ مطور البوت -›«@'..UserSudo..'»*'
...
if text == '/Threethon' or text == 'عوده' or text == 'رجـوع ✭' then  
Redis:sadd(Fast..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "ثري ثون")..
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉◞ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 ˛ َِ𝗛َِ𝗮َِ𝗶َِ𝗱َِ𝗲َِ𝗿 . ❳', url = "https://t.me/TT_LLJ"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج حيدر ', url = "https://t.me/TT_LLJ"}
},
{
{text = '◜𝙨𝙤𝙪𝙍𝘾𝙀 𝙏𝙃𝙍𝙀𝙀 𝙏𝙃𝙊𝙉◞', url = "https://t.me/CCYFC"},
},
...
if text == 'سورس ✭' or text == 'سورس' or text == 'يا سورس' or text == 'source' or text == 'ثري ثون' then
photo = "https://t.me/CCYFC"
local T =[[
