...
if text then
if text:match("(.*)(باوع)(.*)") or text:match("(.*)(شوف)(.*)") then
local Text = ""
keyboard = {} 
...
if text then
if text:match("(.*)(خوش)(.*)") or text:match("(.*)(جمدان)(.*)") then
local Text = ""
keyboard = {} 
keyboard.inline_keyboard = {
{
